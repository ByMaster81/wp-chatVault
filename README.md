...
```bash
# Repoyu indirin
git clone https://github.com/KULLANICI_ADINIZ/whatsapp-viewer.git
cd whatsapp-viewer
...
Uygulama saniyeler içinde açılacak. Tarayıcınızdan **http://localhost:3000** adresine giderek sohbetlerinizi okuyabilirsiniz. Bilgisayarınızdaki `public/backups` klasörüne yeni sohbet attığınız an, Docker bunu otomatik görüp sayfaya yansıtacaktır.
